...
- `artifactType: "html"` remains a reserved form: it parses so the publisher can return `unsupported_reserved_type` at the service boundary. The command reservation mechanism remains available for future verbs.
